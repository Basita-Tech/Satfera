...
const EducationDetails = ({
  ...
  const qualificationLevels = useMemo(() => ["High School", "Undergraduate", "Associates Degree", "Bachelors", "Honours Degree", "Masters", "Doctor", "Doctorate", "Diploma", "Trade School", "Less Than High School"], []);
