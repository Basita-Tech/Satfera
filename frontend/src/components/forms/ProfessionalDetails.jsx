        ...
        <form onSubmit={handleNext} className="space-y-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              ...
              <CustomSelect
                name="occupation"
                value={formData.occupation ? formData.occupation.value : ''}
                onChange={e => {
                  handleSelectChange('occupation', e.target.value ? { label: e.target.value, value: e.target.value } : null);
                }}
                options={jobOptions.map(opt => opt.label)}
